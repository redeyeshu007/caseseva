...
export const StaggeredMenu = ({
  ...
  // We can hide the text or change it to 'Settings'
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <button
          ...
          type="button"
        >
          {/* Hidden text refs required by GSAP logic */}
          ...
          {/* Custom Gear Icon */}
          <span className="sm-toggle-custom-icon">
      ...
      <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open}>
        {logoUrl && (
          <div className="sm-panel-logo-container">
            <img
              src={logoUrl}
              alt="Logo"
              draggable={false}
              ...
              items.map((it, idx) => (
                <li className="sm-panel-itemWrap" key={it.label + idx}>
                  <a className="sm-panel-item" href={it.link} aria-label={it.ariaLabel} data-index={idx + 1} onClick={closeMenu}>
                    ...
                    <span className="sm-panel-itemArrow">
        ...
        <div style={{ marginTop: 'auto', paddingTop: '2rem', display: 'flex', justifyContent: 'center' }}>
          ...
          >
            <span>{isCtaHovered ? "Explore" : "Open Your Case"}</span>
            <svg 
              className={`javix-navbar-cta-icon ${isCtaHovered ? 'icon-hovered' : ''}`} 
